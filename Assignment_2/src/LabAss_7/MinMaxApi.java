...
public class MinMaxApi {
	...
	public static void main(String[] args) {
		...
		stud.add(new StudentInfo (1,"Nisha",22,75));
		stud.add(new StudentInfo (2,"PRAJWAL",22,79));
		stud.add(new StudentInfo (3,"Damini",24,80));
		stud.add(new StudentInfo (4,"Aniket",21,86));
		stud.add(new StudentInfo (5,"Divya",22,58));
		stud.add(new StudentInfo (6,"Srushti",22,60));
