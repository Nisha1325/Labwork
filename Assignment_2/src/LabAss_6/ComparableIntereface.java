...
public class ComparableIntereface {
	...
	public static void main(String[] args) {
		...
		d.add(new Agent("Nisha", 105,"Sangli")); // using add method
		d.add(new Agent("Prajwal", 104,"Noida"));
		d.add(new Agent("Atharava",101,"Shimla"));
		d.add(new Agent("swara", 103,"Karachi"));
		d.add(new Agent ("Shrushti",102,"Janji"));
